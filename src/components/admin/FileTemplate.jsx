...
const FileTemplate = () => {
  ...
  const getCurrentTabValue = () => {
    if (location.pathname === "/admin/work-management") return 0;
  ...
  const fetchCourses = async () => {
    ...
    try {
      const response = await axios.get(
        "http://localhost:3000/courses/all-courses?typeId=3&template=true",
        config
      );
      ...
      const coursesWithFiles = courses.map((course) => ({
        ...
        isTemplate: course.template === true,
      }));
      ...
      >
        <Box sx={{ borderBottom: 1, borderColor: "divider", mb: 2 }}>
          <Tabs value={tabValue} onChange={handleChangeTab}>
            <Tab
              ...
              to="/admin/work-management"
            />
            <Tab
              label="FileTemplate"
              component={RouterLink}
              to="/admin/file-template"
            />
          </Tabs>
        </Box>
        <Grid
        ...
        >
          ...
          <Button
            ...
            startIcon={<AddIcon />}
            component={RouterLink}
            to="/admin/work-management/uploadwork"
          >
            作成済み
          </Button>
        </Grid>
                        ...
                        course.videoUrl.endsWith(".jpeg") ? (
                          ...
                          >
                            ...
                            <Typography variant="body2" sx={{ ml: 1 }}>
                              {getFileUrl(course.videoUrl)?.split("/").pop()}
                            </Typography>
                          </Box>
